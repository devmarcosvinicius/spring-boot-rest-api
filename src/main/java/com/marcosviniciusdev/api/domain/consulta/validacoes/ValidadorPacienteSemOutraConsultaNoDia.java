...
public class ValidadorPacienteSemOutraConsultaNoDia implements ValidadorAgendamentoDeConsulta {
    ...
    public void validar(DadosAgendamentoConsulta dados) {
        ...
        var pacientePossuiOutraConsultaNoDia = reposity.existsByPacienteIdAndDataBetween(dados.idPaciente(), primeiroHorario, ultimoHorario);

        if (pacientePossuiOutraConsultaNoDia) {
            throw new ValidacaoException("Paciente já possui uma consulta agendada nessa dia");
        }
